...
- **Public surface synced to the live repo** — metadata, catalog counts, plugin manifests, and install-facing docs now match the actual OSS surface: 62 agents, 235 skills, and 78 legacy command shims.
...
**That's it!** You now have access to 62 agents, 235 skills, and 78 legacy command shims.
...
|---------|------------|------------|-----------|----------|----------------|
| **Agents** | 62 | Shared (AGENTS.md) | Shared (AGENTS.md) | 12 | N/A |
| **Commands** | 78 | Shared | Instruction-based | 35 | 6 prompts |
| **Skills** | 235 | Shared | 10 (native format) | 37 | Via instructions |
