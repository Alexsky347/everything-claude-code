...
- **Public surface synced to the live repo** — metadata, catalog counts, plugin manifests, and install-facing docs now match the actual OSS surface: 62 agents, 246 skills, and 76 legacy command shims.
...
**That's it!** You now have access to 62 agents, 246 skills, and 76 legacy command shims.
