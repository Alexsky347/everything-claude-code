...
- Use @DisplayName with givenX_whenY_thenZ naming
- Always include explicit AAA (Arrange-Act-Assert) comments
- Use AssertJ assertions exclusively (not JUnit assertions)
- Test all edge cases, error scenarios, and happy paths
- Aim for 80% line coverage and 70% branch coverage minimum
