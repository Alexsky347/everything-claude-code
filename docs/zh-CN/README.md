...
**搞定！** 你现在可以使用 62 个智能体、235 项技能和 78 个命令了。
...
|---------|-------------|----------|--------|
| 智能体 | PASS: 62 个 | PASS: 12 个 | **Claude Code 领先** |
| 命令 | PASS: 78 个 | PASS: 35 个 | **Claude Code 领先** |
| 技能 | PASS: 235 项 | PASS: 37 项 | **Claude Code 领先** |
...
|---------|------------|------------|-----------|----------|
| **智能体** | 62 | 共享 (AGENTS.md) | 共享 (AGENTS.md) | 12 |
| **命令** | 78 | 共享 | 基于指令 | 35 |
| **技能** | 235 | 共享 | 10 (原生格式) | 37 |
